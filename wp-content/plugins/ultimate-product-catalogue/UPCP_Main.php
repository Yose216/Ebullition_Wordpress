...
function UPCP_Add_Stylesheet() {
	...
	if ($Full_Version == "Yes") {
    	...
    	wp_register_style( 'lightgallery-style', plugins_url('css/lightgallery.css', __FILE__) );
...
function Add_UPCP_FrontEnd_Scripts() {
	...
	if ($Lightbox == "Yes" or $Lightbox == "Main") {
		...
		wp_enqueue_script('lightgallery', plugins_url("js/lightgallery.js", __FILE__), array('jquery'));
		wp_enqueue_script('lg-autoplay', plugins_url("js/lg-autoplay.js", __FILE__), array('jquery'));
		wp_enqueue_script('lg-fullscreen', plugins_url("js/lg-fullscreen.js", __FILE__), array('jquery'));
		wp_enqueue_script('lg-hash', plugins_url("js/lg-hash.js", __FILE__), array('jquery'));
		wp_enqueue_script('lg-pager', plugins_url("js/lg-pager.js", __FILE__), array('jquery'));
		wp_enqueue_script('lg-thumbnail', plugins_url("js/lg-thumbnail.js", __FILE__), array('jquery'));
		wp_enqueue_script('lg-video', plugins_url("js/lg-video.js", __FILE__), array('jquery'));
		wp_enqueue_script('lg-zoom', plugins_url("js/lg-zoom.js", __FILE__), array('jquery'));
	}
