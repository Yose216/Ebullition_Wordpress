...
function UPCP_Add_Modified_Styles() {
	...
	if (get_option("UPCP_Details_Icon_Type") != "Font") {
		...
		if (get_option("UPCP_Details_Icon_Color") != "") {".upcp-details-icon {color: " . get_option("UPCP_Details_Icon_Color") . ";}\n";}
		if (get_option("UPCP_Details_Icon_Font_Size") != "") {".upcp-details-icon {font-size: " . get_option("UPCP_Details_Icon_Font_Size") . "px;}\n";}
	}
