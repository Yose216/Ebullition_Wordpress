<?php $SubCategory = $wpdb->get_row($wpdb->prepare("SELECT * FROM $subcategories_table_name WHERE SubCategory_ID ='%d'", $_GET['SubCategory_ID'])); ?>
		...
		<div class="OptionTab ActiveTab" id="EditSubCategory">
				...
				<div class="form-wrap SubCategoryDetail">
					...
					<div class='form-field'>
						<label for="SubCategory_Image"><?php _e("Image", 'UPCP') ?></label>
						...
						<p><?php _e("An image that will be displayed in association with this sub-category, if that option is selected in the 'Options' tab. Current Image:", 'UPCP') ?><br/><img class="PreviewImage" height="100" width="100" src="<?php echo $SubCategory->SubCategory_Image;?>" /></p>
						<div class='clear'></div>
					</div>
